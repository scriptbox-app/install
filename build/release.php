...
$metadata = ['version' => $release['version'], 'protocol' => 'installer-v1', 'installer_sha256' => $hash, 'signing_key_ids' => array_keys($release['public_keys']), 'created_at' => gmdate(DATE_ATOM)];
