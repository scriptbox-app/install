...
$launcherHash = hash_file('sha256', $root . '/index.php');
$metadata = ['version' => $release['version'], 'protocol' => 'installer-v1', 'installer_sha256' => $hash, 'launcher_sha256' => $launcherHash, 'bundle_files' => ['index.php', 'install.php', 'install.php.sha256', 'release.json'], 'signing_key_ids' => array_keys($release['public_keys']), 'release_timestamp' => $release['release_timestamp']];
